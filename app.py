...
from fastapi import FastAPI, Depends, UploadFile, File, Form, HTTPException, Request, Header, BackgroundTasks
...
@app.get("/api/health")
def health_check():
    return {"status": "healthy", "service": "clipflow-backend"}
...
# Enable CORS for frontend (supports local dev, custom CORS_ORIGINS, and *.vercel.app deployments)
...
# Mount built React frontend SPA at root /
